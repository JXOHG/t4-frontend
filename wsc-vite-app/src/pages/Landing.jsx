        ...
        <>
            <div className="w-full left-0">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start sm:justify-center gap-8 sm:gap-16 mb-12 max-w-5xl">
                    ...
                    <div className="w-36 h-36 sm:w-32 sm:h-32 rounded-full border-4 border-purple flex items-center justify-center transition-shadow duration-300 hover:shadow-[0_0_30px_#7f42a9]">
                ...
                {/* SPONSORS CAROUSEL */}
                <h2 className="text-4xl font-georgia font-bold mb-16 px-12">Our Esteemed Sponsors</h2>
                ...
                <div className="marquee-track">
                    ...
                    {[...Array(5)].map((_, index) => (
                        ...
                        >
                            ...
                            <div className="w-36 h-36 md:w-48 md:h-48 flex-shrink-0 flex items-center justify-center">
                            ...
                            <div className="w-36 h-36 md:w-48 md:h-48 pr-8 md:pr-12 flex-shrink-0 flex items-center justify-center">
