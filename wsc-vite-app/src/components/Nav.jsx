  ...
  return (
    <header className="top-0 left-0 w-full z-50 text-white bg-transparent">
      <div className="px-4 md:px-10 lg:px-16 py-3 md:py-6 lg:py-8 flex items-center justify-between">
        ...
        <a href="/" className="text-md md:text-lg lg:text-xl font-bold whitespace-nowrap">Western Sales Club</a>
        <nav
        ...
        >
          ...
          <ul className="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 px-4 md:px-0 py-4 md:py-0">
