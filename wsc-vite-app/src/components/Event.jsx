  ...
  return (
    <div className="flex flex-col items-center text-white rounded-lg shadow-md m-4 p-6 md:flex-row w-full md:max-w-4xl mx-auto border border-gray-700 hover:border-gray-500 transition-colors duration-300">
      ...
      <div className="w-full md:w-2/3 mt-4 md:mt-0 md:ml-6 text-center md:text-left">
        ...
        <div className="flex flex-col sm:flex-row justify-center md:justify-start sm:items-center text-white-400 mt-2">
          <p className="mr-4 flex items-center justify-center md:justify-start">
