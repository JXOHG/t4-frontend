        ...
        <>
            <div className="w-full left-0">
                ...
                <div className="w-full py-16 flex flex-col items-center">
                    <h2 className="text-4xl font-georgia font-bold mb-16">What We Do</h2>
                    <div className="flex justify-center gap-32">
                        <div className="flex flex-col items-center">
                            <div className="w-32 h-32 rounded-full border-4 border-purple flex items-center justify-center mb-6">
                    ...
                    <hr className="w-2/3 mt-20 border-1 border-[#F9C726]" />
                </div>
                <div className="w-full pt-5 pb-16 flex flex-col items-center">
                ...
                <div className="relative w-full h-[50vh] flex flex-col items-center">
